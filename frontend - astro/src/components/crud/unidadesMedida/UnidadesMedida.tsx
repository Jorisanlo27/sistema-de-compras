...
import FormEdit from "../unidadesMedida/FormEdit";

export default function UnidadesMedida() {
    const [unidadMedida, setUnidadMedida] = useState<UnidadMedida>({} as UnidadMedida);
    const [unidadesMedida, setUnidadesMedida] = useState<UnidadMedida[]>([]);

    useEffect(() => {
        (async () => {
            const response = await fetch("/services/unidadesmedida",
                {
                    headers: {
    ...
    const handleDelete = async (id: number | null) => {
        await fetch("/services/unidadesmedida",
            {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json"
    ...
    return (
        <>
                        ...
                        <div className="overflow-hidden shadow">
                            <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                    {unidadesMedida.map((unidadMedida: UnidadMedida, i) => (
                                        <tr key={i} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                            ...
                                            <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <data value="descripcion">{unidadMedida.descripcion}</data>
                                            </td>
                                            ...
                                            <td className="p-4 space-x-2 whitespace-nowrap">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => handleDelete(unidadMedida.id)}
            ...
            <FormEdit unidadMedida={unidadMedida} />
        </>
    )
}