...
export default function Articulos() {
  const [articulo, setArticulo] = useState<Articulo>({} as Articulo);
  ...
  const handleClickEdit = (articulo: Articulo) => {
              ...
              <div className="overflow-hidden shadow">
                <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    {articulos.map((articulo: Articulo, i) => (
                      <tr
                      ...
                      >
                        ...
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          <data value="marca">{articulo.marca.nombre}</data>
                        </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          <data value="descripcion">
                            {articulo.unidadMedida.descripcion}
                          </data>
                        </td>
                        <td className="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          <data value="descripcion">{articulo.existencia}</data>
                        </td>
                        ...
                        <td className="p-4 space-x-2 whitespace-nowrap">
                          <button
                            ...
                            onClick={() => handleClickEdit(articulo)}
                          >
                            <svg
