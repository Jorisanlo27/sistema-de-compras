...
export default function FormEdit({ departamento }: { departamento: Departamento }) {
    const [estado, setEstado] = useState<string>(String(departamento?.estado));
    ...
    async function submit(e: FormEvent<HTMLFormElement>) {
        ...
        await fetch("/services/departamentos", {
            method: "PUT",
            body: formData,
        });
        location.reload();
        ...
        >
            ...
            <form onSubmit={submit} id="form_edit">
                <div className="space-y-4">
                    ...
                    <div
                        className="left-0 flex justify-center w-full pt-10 space-x-4 md:px-4 md:absolute"
                    >
                        <button
                            type="submit"
